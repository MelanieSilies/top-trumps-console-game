     ...
     rl.question('Spieler 1, wie ist dein Name? ', (answer) => {
      ...
      rl.question('Spieler 2, wie ist dein Name? ', (answer) => {
        ...
        rl.question(`${players[0].name} du startest. Mit welcher Eigenschaft gehst du ins Duell? `, (answer) => {
          ...
          const eigenschaftSp1 = selectedCard[choosenEigenschaft];

          const eigenschaftSp2 = selectedCard2[choosenEigenschaft];
          ...
          //         const eigenschaftSp2 = selectedCard2[choosenEigenschaft];
          //         console.log(kampfRunde());
          //       });
          //     } else {
          //       rl.question(`${players[1].name} du startest. Mit welcher Eigenschaft gehst du ins Duell? `, (answer) => {
          //         const choosenEigenschaft = answer;
